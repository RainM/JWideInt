...
public class WInt128 extends Number implements Comparable<WInt128> {
    ...
    public WInt128(WInt128 wi) {
        System.arraycopy(wi.__byte_data, 0, this.__byte_data, 0, this.__byte_data.length);
    ...
    public static native void __native_i128_setl(byte[] a, long l);

    public static native void __native_i128_add(byte[] a, byte[] b);

    public static native void __native_i128_sub(byte[] a, byte[] b);

    public static native void __native_i128_mul(byte[] a, byte[] b);

    public static native void __native_i128_div(byte[] a, byte[] b);

    public static native long __native_i128_to_long(byte[] a);

    public static native double __native_i128_to_double(byte[] a);
